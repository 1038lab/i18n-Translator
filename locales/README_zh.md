...
本指南将帮助您快速设置GitHub Actions自动翻译系统,使用我们提供的工具自动将英语README.md文件转换为多种语言.
...
###  3.2文件说明
 ...
 - ** `translate-readme-api.yml` **  -  API模式GitHub Actions工作流量文件
 - ** `translate-readme-free.yml` **  - 免费模式GitHub Actions工作流量文件

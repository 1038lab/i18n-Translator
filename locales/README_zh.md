...
| 选项 | 描述 | 默认 |
| :----------- | ---------------------------------- |
| `enabled` | 启用/禁用自动翻译 | `true` |
| `mode` | 翻译模式:“免费”或“ api” | `"free"` |
| `source_file` | 源文件要翻译 | `"README.md"` |
| `output_dir` | 翻译的输出目录 | __inline_11_ |
| `enabled_languages` | 目标语言列表 | `["en", "zh"]` |
| `protected_terms` | 避免翻译的术语 | 请参阅配置文件 |

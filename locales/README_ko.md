...
| 🌐 언어 | 📄 파일 | 📊 상태 |
|:-----------|:--------|:----------|
| 🇺🇸 영어 | [README.md](README.md) | ✅ 현재 |
| 🇨🇳 중국어 (中文) | [README_zh.md](locales/README_zh.md) | ✅ 사용 가능 |
| 🇯🇵 일본어 (日本語) | [README_ja.md](locales/README_ja.md) | ✅ 사용 가능 |
| 🇰🇷 한국어 (한국어) | [README_ko.md](locales/README_ko.md) | ✅ 사용 가능 |

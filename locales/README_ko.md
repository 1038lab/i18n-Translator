...
| 🇰🇷 Korean (한국어) | [README_ko.md](./README_ko.md) | **Current** |

> 📝 Choose your preferred language above

---
테스트 프로젝트에 오신 것을 환영합니다! 이 README에는 번역 기능을 테스트하기 위한 다양한 Markdown 요소가 포함되어 있습니다.
...
- **간편한 설정** - `npm install`만 실행하면 사용 준비 완료
- **API 통합** - REST 및 API와의 원활한 통합
...
1. Heroku CLI를 설치합니다.
2. Heroku에 로그인합니다: `heroku login`
3. 앱을 생성합니다: `heroku create your-app-name`
4. 배포합니다: `git push heroku main`
...
코드 포맷팅을 위해 ESLint 및 Prettier을 사용합니다.
...
---
> 🌐 이 문서는 Google Translate로 자동 번역되었습니다. [영문 원본](../README.md)도 확인해보세요 | 번역 도구: [i18n-Translator](https://github.com/1038lab/i18n-Translator)

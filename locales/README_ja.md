...
| 🌐 言語 | 📄 ファイル | 📊 ステータス |
|:-----------|:---------|:----------|
| 🇺🇸 英語 | [README.md](README.md) | ✅ 最新 |
| 🇨🇳 中国語 (中文) | [README_zh.md](locales/README_zh.md) | ✅ 利用可能 |
| 🇯🇵 日本語 (日本語) | [README_ja.md](locales/README_ja.md) | ✅ 利用可能 |
| 🇰🇷 韓国語 (한국어) | [README_ko.md](locales/README_ko.md) | ✅ 利用可能 |
